...
$query = mysql_query("SELECT * FROM livematches order by match_id desc limit 0,5",$obj->connect) or die('could not select'.mysql_error());
...
$query_2= mysql_query("SELECT * FROM upcomingevents 
						order by match_id desc limit 0,15 ",$obj->connect) or die('could not select'.mysql_error());
	...
	//$search = mysql_query("Select * from livematches WHERE country LIKE'g%'",$connect) or die('could not find'.mysql_error());
...
<div class="logo_box"><img src="images/alabi logo.png" width="260" height="63" /></div> 
    ...
    <div class="navbar">
    	<div class="button"><a href="Sport.php">SPORT</a></div>
