...
<div class="middle">
 ...
 <div class="textbox-header">Simple,fast and reliable way to make real money!</div>
 <div class="txtbox">AlabiBet is the registered trading name of AUG Gaming Networks Limited.<br />
   <br />
AUG Gaming Networks Limited hold the Enugu State Lotteries Board license,   the Sportsbook and Gaming license issues by the State of Osun, and hold   licenses to operate in all States where sports betting is permitted in   Nigeria.<br />
AUG Gaming Networks draws upon the best practices in both Europe and   Africa. Our technology centre is based in Europe to ensure the   reliability and security of our systems and your transactions. Our   customer facing operations are based in Lagos to ensure the customer   experience is unparalleled.<br />
AUG Gaming Networks set the standard for online, mobile and retail excellence in Nigeria.</div>

<div class="textbox-header">Secure and reliable</div>
<div class="txtbox">
AlabiBet works with the best operators in the world to guarantee the best betting conditions.
The computer system and data are protected using Dell servers and Fortinet Firewall, and feature a Thawte SSL encryption certificate.</div>
<div class="textbox-header">Real winnings</div>
<div class="txtbox">Your winnings are real. You can play the games for free or bet real money and win. You can transfer your winnings straight across to your bank account at any time, whenever you want.
Every day, thousands of players withdraw their winnings and AlabiBet guarantees to pay out on all winning bets</div>
<div class="textbox-header">All the big sporting events</div>
<div class="txtbox">AlabiBet covers all the major sporting events across Europe and the world. We have great odds and also great combinations of bets like First Goalscorer and Half-Time/Full-Time. In Live Betting the odds change right up to the 90th minute. On a Saturday there may be as many as 10,000 different bets on offer.</div>
</div>
