...
$login= mysql_query("SELECT * 
				FROM registration 
				WHERE Username='$u' && password1='$p'",$connect) or die('could not login'.mysql_error($connect));
...
<div class="left_side">
<div class="holder">
	<div class="srch"><form action="search.php" method="get"><input name="search" type="text" class="srch" id="search" placeholder="Search by Name"  title="Search"/> </form></div>
