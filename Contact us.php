...
<div class="middle">
 <div class="header">HEAD QUATER ADDRESS</div>
 <div class="head">
 <div class="logo"> <img src="images/location.png" width="72" height="72" />
</div>
 <div class="txtbox">AlabiBet
 House
36, 12 Crescent, Gwarinpa Estate,
Abuja.F.C.T.</div>
 </div>
 
 <div class="header">TELEPHONE</div>
 <div class="head">
 <div class="logo"><img src="images/cs.png" width="72" height="72" /></div>
 <div class="txtbox">To contact our call center, dial +234-8138667123</div>
 </div>

<div class="header">EMAIL ADDRESS</div>
 <div class="head">
 <div class="logo"><img src="images/email.png" width="72" height="72" /></div>
 <div class="txtbox">Send us an email and we will reply to your query within 24 hours.<br />
Please provide full information about your query, including your Username.<br />
If you are an Agent, please use <a href="mailto:as@mybet9ja.com">as@myalabibet.com</a><br />
If you are an Online Customer, please use <a href="mailto:cs@mybet9ja.com">cs@myalabibet.com</a></div>
 </div>

<div class="header">TWITTER</div>
 <div class="head">
 <div class="logo"><img src="images/twitter.png" width="72" height="72" /></div>
 <div class="txtbox">Have a quick question for us?<br />
Get in touch through out Twitter customer service here:<br />
<a href="https://twitter.com/AlabiBetHelp" target="blank">https://twitter.com/AlabiBetHelp</a></div>
 </div>

 <div class="header">FACEBOOK</div>
 <div class="head">
 <div class="logo"><img src="images/facebook.png" width="72" height="72" /></div>
 <div class="txtbox">Have a quick question for us?<br />
Get in touch through out Facebook customer service here:<br />
<a href="https://twitter.com/Bet9jaHelp" target="blank">https://facebook.com/AlabiBetHelp</a></div>
 </div>
