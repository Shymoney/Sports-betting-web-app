...
<link href="css/How to Deposit.css" rel="stylesheet" type="text/css" />
<style type="text/css">
body {
	margin-top: 0px;
	margin-left: 0px;
...
<div class="middle">
<div class="header">How to Deposit</div>
<div class="txtbox">
<div class="head_box">Methods</div>
<div class="head_box">Description</div>
<div class="short_box">Fee</div>
<div class="short_box">Instant</div>
<div class="head_box">Limit</div>
<div class="tutorial">Tutorial</div>
</div>

<div class="row">
<div class="head_boxCopy">
<img src="images/card_logos.png" width="136" height="61" />
</div>
<div class="head_boxCopy">Naira Debit Card</div>
<div class="short_boxCopy">Free</div>
<div class="short_boxCopy">Instant</div>
<div class="head_boxCopy">Min: 100<br />
   Max: 100,000</div>
<div class="tutorialCopy">
<img src="images/info.png" width="31" height="74" />
</div>
</div>

<div class="row">
<div class="head_boxCopy">
<img src="images/UBABank.png" width="115" height="53" />
</div>
<div class="head_boxCopy">Bank Collect</div>
<div class="short_boxCopy">Free</div>
<div class="short_boxCopy">Instant</div>
<div class="head_boxCopy">Min: 100<br />
   Max: 100,000</div>
...
<div class="row">
<div class="head_boxCopy">
<img src="images/ZenithBank.png" width="60" height="48" />
</div>
<div class="head_boxCopy">XPath</div>
<div class="short_boxCopy">Free</div>
<div class="short_boxCopy">Instant</div>
<div class="head_boxCopy">Min: 100<br />
   Max: 100,000</div>
...
<div class="row">
<div class="head_boxCopy">
<img src="images/gtbanklogo.jpg" width="48" height="48" />
</div>
<div class="head_boxCopy">GTBank</div>
<div class="short_boxCopy">Free</div>
<div class="short_boxCopy">Instant</div>
<div class="head_boxCopy">Min: 100<br />
   Max: 100,000</div>
...
<div class="header">How to Withdraw</div>
<div class="txtbox">
<div class="head_box">Methods</div>
<div class="head_box">Description</div>
<div class="short_box">Fee</div>
...
<div class="row">
<div class="head_boxCopy">
<img src="images/icon_withdrawmethods.png" width="136" height="61" />
</div>
<div class="head_boxCopy">Bank Transfer</div>
<div class="short_boxCopy">Free</div>
<div class="short_boxCopy">Within 24<br />
banking hours</div><div class="head_boxCopy">Min: 100<br />
   Max: 100,000</div>
<div class="tutorialCopy">
<img src="images/info.png" width="31" height="74" />
</div>
